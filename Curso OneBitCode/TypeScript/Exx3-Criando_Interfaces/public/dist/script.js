const users = []; //array para salvar todos os users adicionados e suas locações ao sistema
...
const saveUser = async (username) => {
    ...
    const user = await certificate_users.json(); //o .json() converte para um objeto do JS
    console.log(user);
    if (user.message)
